...
if __name__ == "__main__":
    ...
    optimized_params_for_all_slices_output_file_name = "psf-ext2_optimized_alphas.json"
    optimized_params_over_all_slices_output_file_name = "psf-ext2_optimized_alpha_over_all_slices.json"
