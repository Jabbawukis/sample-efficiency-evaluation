...
def evaluate_aliases(bear_size):
    ...
    match_dict_no_aliases = load_json_dict(
        f"../../../sample_efficiency_evaluation_results/fact_matching_results/BEAR-{bear_size}/wikimedia_wikipedia_20231101_en/no_aliases/relation_occurrence_info.json"
    )
    match_dict_aliases = load_json_dict(
        f"../../../sample_efficiency_evaluation_results/fact_matching_results/BEAR-{bear_size}/wikimedia_wikipedia_20231101_en/relation_occurrence_info.json"
    )
